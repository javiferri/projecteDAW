    <head>
		<script language="javascript" src="./moduloentrenador/js/eliminarEntrenador.js" type="text/javascript"></script>
...
<fieldset>
		  <legend>Eliminar Entrenador:</legend>
<table border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td colspan="4" valign="middle"><label>
	  Entrenador: <input name="buscar" type="text" id="buscar" autocomplete="off"/></label></td>
    </tr>
        ...
        <tr>
		  ...
		  <td><label>
			<select name="criterio_ord" id="criterio_ord" >
				<option value="id_Entrenador" >ID Cliente</option>	
