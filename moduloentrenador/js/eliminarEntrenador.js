...
function presionTecla(e){
  ...
  conexion1.open('GET','./moduloentrenador/modelos/eliminar_entrenador.php?text='+document.getElementById('buscar').value+"&radio1="+document.getElementById('radio1').checked+
...
function eliminar(idE){
	...
	conexion2.open('GET','./moduloentrenador/controladores/entrenadorControlador.php?idE='+idE, true);
	conexion2.send(null);
}
