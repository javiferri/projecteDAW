...
function presionTecla(e){
  ...
  conexion1.open('GET','./moduloentrenador/modelos/modifica_entrenador_ajax.php?text='+document.getElementById('buscar').value+"&radio1="+document.getElementById('radio1').checked+
...
function mostrar(id1){
	id = id1;
	$('#modificar').load('./moduloentrenador/modelos/modifica_entrenador_ajax1.php?');
...
function modificar(){
	...
	conexion2.open('GET','./moduloentrenador/controladores/entrenadorControlador.php?idM='+id+"&nombreModifi="+document.getElementById('nombreModifi').value+
	"&pape="+document.getElementById('pape').value+"&sape="+document.getElementById('sape').value+
	"&tele="+document.getElementById('tele').value+"&tipojornada="+document.getElementById('tipojornada').value, true);
	conexion2.send(null);
}
