...
function inicializarEventos(){
  var ob=document.getElementById('entrenador');
...
function presionTecla(e){
  ...
  conexion1.open('GET','./moduloentrenador/modelos/buscar_entrenador_ajax.php?entrenador='+document.getElementById('entrenador').value+"&radio1="+document.getElementById('radio1').checked+
