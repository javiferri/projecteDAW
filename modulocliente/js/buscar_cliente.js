...
function presionTecla(e){
  ...
  conexion1.open('GET','./modulocliente/modelos/buscar_cliente_ajax.php?nombre='+document.getElementById('nombre').value+"&radio1="+document.getElementById('radio1').checked+
