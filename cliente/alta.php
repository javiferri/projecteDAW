...
?>
	...
	<form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post">
				...
				<p>Direccion: </br><INPUT TYPE="text" NAME="dire" SIZE="20" MAXLENGTH="30"></p>
				<p>Telefono: </br><INPUT TYPE="text" NAME="tele" SIZE="20" MAXLENGTH="30"></p>
				<p>Edad: </br><INPUT TYPE="text" NAME="edad" SIZE="20" MAXLENGTH="30"></p>
				<p>
				Modalidad:
				<select name="moda">
				...
				<?php
					...
					$consulta = "select actividad.actividad from actividad where id_Entrenador != 0 ";
				...
				?>
				</select> <strong class= "aviso">* Las Actividades sin entrenador no saldran</strong>
				</p>
...
try{
	...
	$consulta = "insert into clientes (nombre, apellido1, apellido2, direccion, telefono, edad, tipoCliente, modalidad) 
	values ('".$nombre."','".$pape."','".$sape."','".$dire."',".$tele.",".$edad.",'".$tipoclie."','".$moda."')";
	if ($db->query($consulta) === false)
		throw new ExcepcionEnTransaccion();
	$db->commit();
	
	$consulta = "select nombre, apellido1 from clientes";
	$resultado = $db->query($consulta);
	if ($db->errno != 0)
		throw new Exception('Error realizando consulta:'.$db->error, $db->errno);
