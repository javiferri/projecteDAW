...
function presionTecla(e){
  ...
  conexion1.open('GET','./moduloactividad/modelos/eliminar_actividad.php?text='+document.getElementById('buscar').value+"&radio1="+document.getElementById('radio1').checked+
...
function eliminar(idE){
	...
	conexion2.open('GET','./moduloactividad/controladores/actividadControlador.php?idE='+idE, true);
	conexion2.send(null);
}
